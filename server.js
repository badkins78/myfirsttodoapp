...
app.post("/addChore", (request, response) => {
  db.collection("todoapp")
    .insertOne({
      choreName: request.body.choreName,
      workerName: request.body.workerName,
      supervisorName: request.body.supervisorName,
      timesWeekly: 1,
    })
    .then((result) => {
    ...
    .updateOne(
      {
        ...
        workerName: request.body.workerName,
        supervisorName: request.body.supervisorName,
        timesWeekly: request.body.timesWeekly,
      },
      {
        $set: {
...
app.delete("/deleteChore", (request, response) => {
  db.collection("todoapp")
    .deleteOne({ choreName: request.body.chorename })
    .then((result) => {
